        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttributeOption_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttributeValue_AttributeOption_AttributeOptionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductVariant_AttributeOption_AttributeOptionId",
                        column: x => x.AttributeOptionId,
                        principalTable: "AttributeOption",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductVariant_AttributeValue_AttributeValueId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttributeOption_ProductId",
                table: "AttributeOption",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_AttributeValue_AttributeOptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariant_AttributeOptionId",
                table: "ProductVariant",
                column: "AttributeOptionId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductVariant_AttributeValueId",
                table: "ProductVariant",
